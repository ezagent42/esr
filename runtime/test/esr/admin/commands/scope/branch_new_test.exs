defmodule Esr.Admin.Commands.Scope.BranchNewTest do
  @moduledoc """
  DI-10 Task 20 — `Esr.Admin.Commands.Scope.BranchNew` shells out to
  ...
  alias Esr.Admin.Commands.Scope.BranchNew, as: SessionBranchNew
