defmodule Esr.Admin.Commands.Scope.ListTest do
  @moduledoc """
  DI-10 Task 20 — `Esr.Admin.Commands.Scope.List` reads routing.yaml
  ...
  alias Esr.Admin.Commands.Scope.List, as: SessionList
