defmodule Esr.Admin.Commands.Session.SwitchTest do
  @moduledoc """
  DI-10 Task 20 — `Esr.Admin.Commands.Session.Switch` flips
  ...
  alias Esr.Admin.Commands.Session.Switch, as: SessionSwitch
