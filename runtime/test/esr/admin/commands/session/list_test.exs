defmodule Esr.Admin.Commands.Session.ListTest do
  @moduledoc """
  DI-10 Task 20 — `Esr.Admin.Commands.Session.List` reads routing.yaml
  ...
  alias Esr.Admin.Commands.Session.List, as: SessionList
