defmodule Esr.Entity.FeishuAppAdapterTest do
  ...
  describe "PR-21κ slash dispatch (yaml-driven)" do
    ...
    # to `Esr.Entity.SlashHandler` via `dispatch/3`. The pre-PR-21κ
    ...
    # production handler uses, so `Esr.Entity.SlashHandler.dispatch/3`'s
