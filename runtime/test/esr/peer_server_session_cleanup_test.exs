defmodule Esr.PeerServerSessionCleanupTest do
  ...
  test "session.signal_cleanup delivers {:cleanup_signal, ...} to Admin.Dispatcher" do
    ...
    result = PeerServer.invoke_tool_for_test(peer_state, "session.signal_cleanup", args)
  ...
  test "session.signal_cleanup is a no-op-ack when Dispatcher is not registered" do
    ...
    result =
      PeerServer.invoke_tool_for_test(peer_state, "session.signal_cleanup", %{
