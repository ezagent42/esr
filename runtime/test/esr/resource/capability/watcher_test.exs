defmodule Esr.Resource.Capability.WatcherTest do
  use ExUnit.Case, async: false

  alias Esr.Resource.Capability.{Watcher, Grants}
  ...
  setup do
    ...
    # The app-level Esr.Resource.Capability.Supervisor already runs a Watcher under
    ...
    sup = Esr.Resource.Capability.Supervisor

    if Process.whereis(Watcher) do
      _ = Supervisor.terminate_child(sup, Esr.Resource.Capability.Watcher)
      _ = Supervisor.delete_child(sup, Esr.Resource.Capability.Watcher)
    end
    ...
    on_exit(fn ->
      ...
      _ =
        Supervisor.start_child(sup, %{
          id: Esr.Resource.Capability.Watcher,
          start: {Esr.Resource.Capability.Watcher, :start_link, [[path: prod_path]]}
        })
    end)
