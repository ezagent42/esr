defmodule Esr.Entities.FeishuChatProxyTest do
  use ExUnit.Case, async: false

  alias Esr.Entities.FeishuChatProxy
  ...
  # them upstream and dispatches via `Esr.Entities.SlashHandler.dispatch/3`.
  ...
  describe "channel_adapter lifted from ctx (D1)" do
    test "init/1 stores ctx.channel_adapter under string key in state" do
      ...
      {:ok, state} = Esr.Entities.FeishuChatProxy.init(args)
