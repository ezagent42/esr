defmodule Esr.Entities.CCProcessTest do
  @moduledoc """
  P3-2.1 — `Esr.Entities.CCProcess` is a per-Session `Peer.Stateful` that holds
  ...
  test "build_channel_notification includes app_id from upstream meta" do
    ...
    envelope = Esr.Entities.CCProcess.build_channel_notification(state, "hello")
  ...
  describe "build_channel_notification/2 — PR-C extensions" do
    test "emits user_id alongside user (both = sender_id today)" do
      ...
      env = Esr.Entities.CCProcess.build_channel_notification(state, "hi")
    ...
    test "omits 'reachable' when reachable_set is empty" do
      ...
      env = Esr.Entities.CCProcess.build_channel_notification(state, "x")
