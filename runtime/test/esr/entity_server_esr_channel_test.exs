defmodule Esr.EntityServerEsrChannelTest do
  ...
  setup do
    ...
    AdapterSocketRegistry.register(sid,
      ws_pid: ws_pid,
      chat_ids: ["oc_x"],
      app_ids: ["cli_x"],
      workspace: "w"
  ...
  test "Emit adapter=esr-channel routes via AdapterSocketRegistry + fires emit.dispatched telemetry",
       %{sid: sid} do
    :telemetry.attach(
      "test-esr-ch",
      [:esr, :emit, :dispatched],
    ...
    _new_state = Esr.Entity.Server.dispatch_action_for_test(action, state)
