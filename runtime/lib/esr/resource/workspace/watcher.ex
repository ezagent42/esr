defmodule Esr.Resource.Workspace.Watcher do
  @moduledoc """
  Watches `workspaces.yaml` and reloads `Esr.Resource.Workspace.Registry` on
  any change event. Modeled on `Esr.Resource.Capability.Watcher` (same
