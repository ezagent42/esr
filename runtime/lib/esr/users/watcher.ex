defmodule Esr.Users.Watcher do
  @moduledoc """
  Watches `users.yaml` and triggers `Esr.Users.FileLoader.load/1` on
  any change event. Performs the initial load on start.

  Mirrors `Esr.Capabilities.Watcher` (same FSEvents-based pattern;
