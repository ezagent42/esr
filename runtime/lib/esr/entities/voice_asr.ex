defmodule Esr.Entities.VoiceASR do
  @moduledoc """
  Pool-worker `Esr.Entity.PyWorker` owning one `voice_asr` Python sidecar.
  Scaling axis: pool size (default 4, `pools.yaml` override) managed by
  `Esr.Entity.Pool` registered as `:voice_asr_pool`.

  Spec §4.1 VoiceASR card.
  """

  @behaviour Esr.Role.Pipeline
  use Esr.Entity.PyWorker, module: "voice_asr"
