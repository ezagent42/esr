defmodule Esr.Entity.UnboundUserGuard do
  @moduledoc """
  ...
  otherwise `Esr.Entity.UnboundChatGuard` takes precedence so
  operators don't get pelted with two DMs.

  Extracted from `Esr.Entity.FeishuAppAdapter` by PR-21w. Symmetric
  to `Esr.Entity.UnboundChatGuard` — same migration rationale, same
  shape.
