defmodule Esr.Entity.UnboundChatGuard do
  @moduledoc """
  ...
  fall through to `Esr.Session.Router`, which silently maps unknown
  ...
  Extracted from `Esr.Entity.FeishuAppAdapter` by PR-21w. Migration
