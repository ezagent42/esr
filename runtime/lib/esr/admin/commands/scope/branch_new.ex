defmodule Esr.Admin.Commands.Scope.BranchNew do
  @moduledoc """
  `Esr.Admin.Commands.Scope.BranchNew` — spawns an ephemeral esrd for
  ...
  path lives in `Esr.Admin.Commands.Scope.New` (kind `session_new`).
