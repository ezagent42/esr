defmodule Esr.Admin.Commands.Session.BranchNew do
  @moduledoc """
  `Esr.Admin.Commands.Session.BranchNew` — spawns an ephemeral esrd for
  ...
  path lives in `Esr.Admin.Commands.Session.New` (kind `session_new`).
