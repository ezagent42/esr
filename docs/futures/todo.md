...
- PRs #281–#284 — zero-config bootstrap (PR #281 spec + plan, #282 first user_add auto-admins via sentinel, #283 register_adapter passes app_secret to feishu Python sidecar, #284 docs/guides/{operator-bootstrap-journey,feishu-adapter-setup}.md).
