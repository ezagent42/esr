...
| Phase 3 + Phase 4 status (2026-05-05) | [2026-05-05-phase-3-4-status.md](2026-05-05-phase-3-4-status.md) | Final note for Phase 3 (5/7 shipped, 2 scope-cut: PR-3.5 HTTP MCP / PR-3.4 plugin startup hook) and Phase 4 (4/7, 3 deferred: PR-4.5 CI guard / PR-4.6 Python CLI port / PR-4.7 venv removal). Plugin module isolation achieved: feishu under `plugins/feishu/`, cc under `plugins/claude_code/`. `Esr.Admin.*` namespace collapsed into `Esr.Slash.*`. Cumulative session: 22 PRs (#189–#209). |
